...
It is possible to run PatriotBit as a Tor hidden service, and connect to such services.
...
The first step is running PatriotBit behind a Tor proxy. This will already make all
...
config file):
	...
	HiddenServicePort 51400 127.0.0.1:51400
	HiddenServicePort 14000 127.0.0.1:14000

The directory can be different of course, but (both) port numbers should be equal to
your dashd's P2P listen port (51400 by default).
...
and open port 51400 on your firewall (or use -upnp).
