...
##perform gitian builds
 ...
 Build patriotbitd and patriotbit-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit patriotbit=v${VERSION} ../patriotbit/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../patriotbit/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r patriotbit-${VERSION}-linux-gitian.zip *
	mv patriotbit-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit patriotbit=v${VERSION} ../patriotbit/contrib/gitian-descriptors/gitian-win.yml
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../patriotbit/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r patriotbit-${VERSION}-win-gitian.zip *
	mv patriotbit-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit patriotbit=v${VERSION} ../patriotbit/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
