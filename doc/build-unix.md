UNIX BUILD NOTES
====================
Some notes on how to build PatriotBit in Unix. 
...
memory available when compiling PatriotBit Core. With 512MB of memory or less
...
If you want to build PatriotBit-Qt, make sure that the required packages for Qt development
...
A quick remedy for this problem is to add the flag **-fPIE** on line [163](https://github.com/patriotbit/patriotbit/blob/master/configure.ac#L163) in *configure.ac*
...
# Configure PatriotBit Core to use our own-built instance of BDB
cd $J6Q_ROOT
...
Security
--------
To help make your PatriotBit installation more secure by making certain attacks impossible to
