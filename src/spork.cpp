...
bool CSporkManager::CheckSignature(CSporkMessage& spork)
{
    ...
    if(!freedomSendSigner.VerifyMessage(pubkey, spork.vchSig, strMessage, errorMessage)){
        return false;
    }
...
bool CSporkManager::Sign(CSporkMessage& spork)
{
    ...
    if(!freedomSendSigner.SignMessage(strMessage, errorMessage, spork.vchSig, key2)) {
        LogPrintf("CMasternodePayments::Sign - Sign message failed");
        return false;
    }

    if(!freedomSendSigner.VerifyMessage(pubkey2, spork.vchSig, strMessage, errorMessage)) {
