...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("PatriotBit"),
     ...
     * override -datadir in the patriotbit.conf file in the default data directory
     * (to be consistent with patriotbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
