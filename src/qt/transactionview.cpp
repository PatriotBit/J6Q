    ...
    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Freedomsent"), TransactionFilterProxy::TYPE(TransactionRecord::Freedomsent));
    typeWidget->addItem(tr("Freedomsend Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::FreedomsendMakeCollaterals));
    typeWidget->addItem(tr("Freedomsend Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::FreedomsendCreateDenominations));
    typeWidget->addItem(tr("Freedomsend Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::FreedomsendDenominate));
    typeWidget->addItem(tr("Freedomsend Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::FreedomsendCollateralPayment));
...
void TransactionView::resizeEvent(QResizeEvent* event)
{
    ...
    columnResizingFixer->stretJ6QolumnWidth(TransactionTableModel::ToAddress);
}
