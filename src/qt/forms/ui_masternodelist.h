...
public:
    ...
    void retranslateUi(QWidget *MasternodeList)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tabMyMasternodes), QApplication::translate("MasternodeList", "My FreedomNodes", 0));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tabAllMasternodes), QApplication::translate("MasternodeList", "All FreedomNodes", 0));
    } // retranslateUi
