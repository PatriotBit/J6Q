...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to PatriotBit.", 0));
        label_4->setText(QApplication::translate("Intro", "Upon first launch, you can choose where PatriotBit will store its data.", 0));
        sizeWarningLabel->setText(QApplication::translate("Intro", "PatriotBit will connect to the FreedomNET and parse the PatriotBit Blockchain. At least %1GB of data will be stored in this directory, and like the universe it will expand over time. The wallet will also be stored in this directory.", 0));
