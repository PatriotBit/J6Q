...
public:
    ...
    void retranslateUi(QDialog *DarksendConfig)
    {
        ...
        buttonBasic->setText(QApplication::translate("DarksendConfig", "Conspiracy Theorist", 0));
        buttonHigh->setText(QApplication::translate("DarksendConfig", "Secret Clearance", 0));
        buttonMax->setText(QApplication::translate("DarksendConfig", "Q-Level Paranoia Mode", 0));
        label->setText(QApplication::translate("DarksendConfig", "Please select a privacy level.", 0));
        label_2->setText(QApplication::translate("DarksendConfig", "Use 2 separate FreedomNodes to mix funds up to 1000 DASH", 0));
        label_3->setText(QApplication::translate("DarksendConfig", "Use 8 separate FreedomNodes to mix funds up to 1000 DASH", 0));
        label_4->setText(QApplication::translate("DarksendConfig", "Use 16 separate FreedomNodes", 0));
