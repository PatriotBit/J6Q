...
public:
    ...
    void retranslateUi(QWidget *ReceiveCoinsDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        label_3->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the PatriotBit network.", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        reqMessage->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the PatriotBit network.", 0));
#endif // QT_NO_TOOLTIP
        label_5->setText(QApplication::translate("ReceiveCoinsDialog", "<html><head/><body><p>Use this form to request PatriotBit. All fields are <span style=\" font-weight:600;\">optional</span>.</p></body></html>", 0));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        receiveButton->setText(QApplication::translate("ReceiveCoinsDialog", "&Request PatriotBit", 0));
#ifndef QT_NO_TOOLTIP
        ...
        label_6->setText(QApplication::translate("ReceiveCoinsDialog", "Requested PatriotBit History:", 0));
#ifndef QT_NO_TOOLTIP
