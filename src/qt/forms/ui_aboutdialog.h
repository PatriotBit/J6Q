...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About PatriotBit Core", 0));
        label->setText(QApplication::translate("AboutDialog", "<html><head/><body><p><span style=\" font-weight:600;\">PatriotBit </span>version</p></body></html>", 0));
...
"Copyright &copy; 2014-YYYY The PatriotBit Core developers.", 0));
