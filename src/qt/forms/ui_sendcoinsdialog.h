...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 828, 168));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlFeatures->setText(QApplication::translate("SendCoinsDialog", "PatriotBit SCIF Control Features", 0));
