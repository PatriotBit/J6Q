...
public:
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        label_4->setText(QApplication::translate("RPCConsole", "NetworkNode Count", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the PatriotBit debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
        ...
        label_10->setText(QApplication::translate("RPCConsole", "Blockchain", 0));
