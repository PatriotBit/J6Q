...
public:
    ...
    void setupUi(QDialog *HelpMessageDialog)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 661, 342));
    ...
    {
        HelpMessageDialog->setWindowTitle(QApplication::translate("HelpMessageDialog", "PatriotBit Core - Command-line options", 0));
    } // retranslateUi
