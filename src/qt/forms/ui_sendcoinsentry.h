...
public:
    ...
    void retranslateUi(QStackedWidget *SendCoinsEntry)
    {
...
#endif // QT_NO_TOOLTIP
        payToLabel->setText(QApplication::translate("SendCoinsEntry", "Send &To:", 0));
#ifndef QT_NO_TOOLTIP
        ...
        messageLabel->setText(QApplication::translate("SendCoinsEntry", "PatrioTXT Messaging:", 0));
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the patriotbit: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the PatriotBit network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
